      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex items-center gap-2">
          {onRetailor && (
            <button 
              onClick={onRetailor} 
              className="flex items-center gap-1.5 glass-card border border-white/10 text-white/50 hover:text-white px-3 py-1.5 rounded-lg text-xs transition-all"
            >
          ...
          <button 
            ...
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs border transition-all ${
              preview 
                ? 'bg-[#C9A84C]/12 border-[#C9A84C]/25 text-[#C9A84C]' 
